...
class CrossModalAttentionLayer(nn.Module):
    ...
    def forward(
        ...
        q_feat_m1 = self.norm(q_feat_m1)
        q_embed2 = self.multihead_attn(
            query=self.with_pos_embed(q_feat_m1, q_pos),
            key=self.with_pos_embed(kv_feat_m2, kv_pos),
            value=self.with_pos_embed(kv_feat_m2, kv_pos),
            key_padding_mask=padding_mask,
        )[0]
        q_feat_m1 = q_feat_m1 + self.dropout(q_embed2)
        return q_feat_m1
